...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .teacher-name{font-size:16px;font-weight:700;color:var(--navy-800);margin-bottom:4px}
        .teacher-subject{font-size:13px;color:var(--gold-500);margin-bottom:8px}
        ...
        .btn-add{background:var(--gold-500);color:var(--navy-900);padding:10px 20px;font-size:14px}
